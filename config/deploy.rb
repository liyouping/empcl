...
set :application_name, 'empcl'
#服务器地址,是使用ssh的方式登录服务器
set :domain, 'root@118.89.151.182'
#服务器中项目部署位置
set :deploy_to, '/var/lyp-rails-app/empcl'
#git代码仓库
set :repository, 'https://github.com/liyouping/empcl.git'
#git分支
set :branch, 'master'
...
set :shared_paths, ['config/database.yml', 'tmp', 'config/secrets.yml', 'config/my_config.yml', 'log']
